...
module.exports = require('coa').Cmd()
    ...
    .opt().name('group').title('The tunnel group(s) to run, specify multiple times or use comma separated list').arr().short('g').long('group').val(tunnelAction.validators.tunnelGroup).end()
